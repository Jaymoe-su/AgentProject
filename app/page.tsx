    ...
    <nav className={styles.nav}>
      <div className={styles.navInner}>
        ...
        <div className={styles.navLeft}>
          <span className={styles.navCallsign}>[OPERATOR]</span>
      ...
      <div className={styles.heroInner}>
        ...
        <div className={styles.identityCard}>
          ...
          <div className={styles.identityBody}>
            ...
            <h1 className={styles.identityName}>[YOUR NAME]</h1>
...
function ContactSection() {
  const contactItems = [
    { label: 'EMAIL', value: 'operator@defense.dev' },
    { label: 'LINKEDIN', value: 'linkedin.com/in/operator' },
    { label: 'GITHUB', value: 'github.com/operator' },
          ...
          <div className={styles.terminal}>
            <div className={styles.terminalBar}>
              ...
              <span className={styles.terminalBarTitle}>
                [OPERATOR PROFILE] // BIOGRAPHICAL DATA
              </span>
            </div>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <span className={styles.footerLeft}>
            [OPERATOR PROFILE] // ALL INFORMATION UNCLASSIFIED
          </span>
